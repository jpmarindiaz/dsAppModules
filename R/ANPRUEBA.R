...
#
#
# sliderTextUI <- function(id, sliderTitle = NULL) {
#   ns <- NS(id)
#   tagList(
#     sliderInput(ns("slider"), sliderTitle, 0, 102, 2),
#     textOutput(ns("num")),
...
#     paste("pasos:doble,s:F;;;", input$slider)
#   })
# }
#
# ui <- fluidPage(
#   sliderTextUI("hello", "secuoya"),
#   sliderTextUI("heob", "podlej"),
#   sliderTextUI("hei")
# )
#
# server <- function(input, output) {
#   callModule(sliderText, "hello")
#   callModule(sliderText, "hei")
#}
